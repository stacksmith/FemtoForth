...
$(APP): main.o  header.o data.o table.o interpret.o bindings.o src.o cmd.o
	$(CPP) $(LDFLAGS) -o $(APP) main.o  header.o data.o table.o interpret.o bindings.o src.o cmd.o
